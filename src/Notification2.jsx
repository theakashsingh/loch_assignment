const Notification2 = () => {
  return (
    <div className="right_notification2">
      <div className="icon">
        <svg
          width="29"
          height="28"
        ...
        >
          <path d="M23.0996 25.9004V11.9004" stroke="black" />
          <path d="M14.7002 25.9V3.5" stroke="black" />
          <path d="M6.2998 25.9V17.5" stroke="black" />
        </svg>
        <svg
          width="15"
          height="14"
      ...
      <div className="value">
        <p>$1,000.00</p><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
